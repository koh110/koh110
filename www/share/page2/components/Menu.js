...
const Menu = ({location}) => {
  ...
  return (
    <Root>
      <LinkWrap><Link to="/" style={about}>About</Link></LinkWrap>
      <LinkWrap><Link to="/work" style={work}>Work</Link></LinkWrap>
      <LinkWrap><Link to="/contact" style={contact}>Contact</Link></LinkWrap>
    </Root>
  )
}
Menu.propTypes = {
